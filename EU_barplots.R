...
# Author: Francesca Rosa
  ...
  EUfootprint.barplot <- function(csv_path, case_subcase, plots_path, year) {
      ...
      # save as pdf
      ggsave(paste0(plots_path, "EUFootprint_", year, "_", palette_name, case_subcase, ".pdf"), width = 20, height = 16, units = "cm")
...
# Author: Francesca Rosa
  ...
  EUinternal.barplot <- function(csv_path, case_subcase, plots_path, year) {
    ...
    data<-read.csv(paste0(csv_path, "EUForest_", year, case_subcase, ".csv"), header = TRUE)
    data_top<-read.csv(paste0(csv_path, "EUForest_", year, case_subcase,"_top.csv"), header = TRUE)
    ...
    ggsave(paste0(plots_path, "EUForest_", year, "_", palette_name, case_subcase, ".pdf"), width = 20, height = 16, units = "cm")
