...
plot.global.time.series <- function(csv_path, case_subcase, plots_path, case_areas) {
  ...
  # plot the areas (reload the data and adpt the palette)
    ...
    data <- read.csv(paste0(csv_path_areas, "areas_global_time-series_", case_areas, ".csv"), header = TRUE)
