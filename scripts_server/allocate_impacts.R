...
allocate.impacts <- function(df, fraction_of_areas) {
  ...
  df_disaggr <- df %>% 
    ...
    transmute(Scenario = Scenario, Eco_code = Eco_code, Year = Year,
              ...
              Annual_EU_lower95 = fr_Annual_EU*Annual_lower95, Permanent_EU_lower95 = fr_Permanent_EU*Permanent_lower95, Pasture_EU_lower95 = fr_Pasture_EU*Pasture_lower95, 
              Urban_EU_lower95 = fr_Urban_EU*Urban_lower95, Annual_RoW_lower95 = fr_Annual_RoW*Annual_lower95, Permanent_RoW_lower95 = fr_Permanent_RoW*Permanent_lower95, 
              Pasture_RoW_lower95 = fr_Pasture_RoW*Pasture_lower95, Urban_RoW_lower95 = fr_Urban_RoW*Urban_lower95,
              For_ClearCut_EU_lower95 = fr_For_ClearCut_EU*ClearCut_lower95, For_ClearCut_im_lower95 = fr_For_ClearCut_im*ClearCut_lower95, For_ClearCut_ex_lower95 = fr_For_ClearCut_ex*ClearCut_lower95,
              ...
              For_TimberPlant_EU_lower95 = fr_For_TimberPlant_EU*Plantation_lower95, For_TimberPlant_ex_lower95 = fr_For_TimberPlant_ex*Plantation_lower95, 
              ...
              EP_EU_lower95 = fr_EP_EU*Permanent_lower95, EP_conv_EU_lower95 = fr_EP_conv_EU*Permanent_lower95, EP_RoW_lower95 = fr_EP_RoW*PlantationFuel_lower95, EP_conv_im_lower95 = fr_EP_conv_im*PlantationFuel_lower95, 
              Afforested_EU_lower95 = fr_Afforested_EU*Afforested_lower95, Afforested_RoW_lower95 = fr_Afforested_RoW*Afforested_lower95, Regrowth_lower95 = fr_Regrowth*Afforested_lower95, 
              ForOther_Extensive_EU_lower95 = fr_ForOther_Extensive_EU*ForExtensive_lower95, ForOther_Extensive_RoW_lower95 = fr_ForOther_Extensive_RoW*ForExtensive_lower95, 
              ForOther_Intensive_EU_lower95 = fr_ForOther_Intensive_EU*ForIntensive_lower95, ForOther_Intensive_RoW_lower95 = fr_ForOther_Intensive_RoW*ForIntensive_lower95,
              
              Annual_EU_upper95 = fr_Annual_EU*Annual_upper95, Permanent_EU_upper95 = fr_Permanent_EU*Permanent_upper95, Pasture_EU_upper95 = fr_Pasture_EU*Pasture_upper95, 
              Urban_EU_upper95 = fr_Urban_EU*Urban_upper95, Annual_RoW_upper95 = fr_Annual_RoW*Annual_upper95, Permanent_RoW_upper95 = fr_Permanent_RoW*Permanent_upper95, 
              Pasture_RoW_upper95 = fr_Pasture_RoW*Pasture_upper95, Urban_RoW_upper95 = fr_Urban_RoW*Urban_upper95,
              For_ClearCut_EU_upper95 = fr_For_ClearCut_EU*ClearCut_upper95, For_ClearCut_im_upper95 = fr_For_ClearCut_im*ClearCut_upper95, For_ClearCut_ex_upper95 = fr_For_ClearCut_ex*ClearCut_upper95,
              ...
              For_TimberPlant_EU_upper95 = fr_For_TimberPlant_EU*Plantation_upper95, For_TimberPlant_ex_upper95 = fr_For_TimberPlant_ex*Plantation_upper95, 
              ...
              EP_EU_upper95 = fr_EP_EU*Permanent_upper95, EP_conv_EU_upper95 = fr_EP_conv_EU*Permanent_upper95, EP_RoW_upper95 = fr_EP_RoW*PlantationFuel_upper95, EP_conv_im_upper95 = fr_EP_conv_im*PlantationFuel_upper95, 
              Afforested_EU_upper95 = fr_Afforested_EU*Afforested_upper95, Afforested_RoW_upper95 = fr_Afforested_RoW*Afforested_upper95, Regrowth_upper95 = fr_Regrowth*Afforested_upper95, 
              ForOther_Extensive_EU_upper95 = fr_ForOther_Extensive_EU*ForExtensive_upper95, ForOther_Extensive_RoW_upper95 = fr_ForOther_Extensive_RoW*ForExtensive_upper95, 
              ForOther_Intensive_EU_upper95 = fr_ForOther_Intensive_EU*ForIntensive_upper95, ForOther_Intensive_RoW_upper95 = fr_ForOther_Intensive_RoW*ForIntensive_upper95
