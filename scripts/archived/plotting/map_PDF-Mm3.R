...
# external variables needed: csv_path, file_label, plots_path, id, energy_exports
  
  # results_path = folder where the files to be loaded are stored, file_slost = initial part of the name of the file to be loaded, 
  # file_label = identification words which selects the file, 
