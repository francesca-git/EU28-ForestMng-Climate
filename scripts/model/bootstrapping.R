...
calculate.RR.bs <- function(uncertainties, n, cutoff, ecodata_path) {
  ...
  rr <- prepare.RR(uncertainties, n, ecodata_path) # function available in parameters_calculation.R
  ...
  ##### MERGE THE TWO ARRAY (LAND USE AND FOREST MANAGEMENT) #####
...
prepare.zvalues.bs <- function(n, ecodata_path) {  
