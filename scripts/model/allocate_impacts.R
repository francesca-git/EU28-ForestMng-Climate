...
allocate.impacts <- function(df, fraction_of_areas) {
  ...
  df_disaggr <- df %>% 
    ...
    transmute(Scenario = Scenario, Eco_code = Eco_code, Year = Year,
              ...
              For_ReducedImpactLogging_im_median = fr_For_ReducedImpactLogging_im*ReducedImpactLogging_median,
              ...
              For_ReducedImpactLogging_im_lower95 = fr_For_ReducedImpactLogging_im*ReducedImpactLogging_lower95,
              ...
              For_ReducedImpactLogging_im_upper95 = fr_For_ReducedImpactLogging_im*ReducedImpactLogging_upper95,
