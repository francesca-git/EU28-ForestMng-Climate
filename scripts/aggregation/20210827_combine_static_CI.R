...
# General task: Merging of the files with the results calculated from the real data and the files with the bootstrapped CI
# Date: 04/06/2021
...
#############################################################################################################################################################################
  ...
  combine.static.CI <- function(folder_slost, rdata_path, case_subcase) {
