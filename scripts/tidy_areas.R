...
# Date: started in March 2020
  ...
  tidy.areas <- function(timber) {
    ...
    if (timber == FALSE) { save(data.list.steps, ecoregions_in_Globiom, EU_ecoregions, Globiom_eco_EU, Globiom_eco_org, urban, file = "./results/areas/areas-to-match.RData") 
      } else if (timber == TRUE) { save(data.list.steps, ecoregions_in_Globiom, EU_ecoregions, Globiom_eco_EU, Globiom_eco_org, urban, file = "./results/areas/areas-to-match_timber.RData") }
