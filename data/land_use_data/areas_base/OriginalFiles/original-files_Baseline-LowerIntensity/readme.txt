...
Folder data/land_use_data/areas_base/OriginalFiles/original-files_Baseline-LowerIntensity
...
WARNING: In the original files, in the results and in the aggregated values (see below), the labeling of the scenarios is slightly different
          ...
          RCP2.6                     RCP
          RCP6.5                     REF
          CFM                        MFM (multifunctional forest management, see below)
          12.5% or SFM 12.5%         AFM25 (the difference in % is due to the fact that the % in the scenarios listed in the 
                                            ...
                                            currently under forest management, to which the figures and results in the manuscript are referred, see below)
...
Non comprehensive list of the file contained in this folder:
